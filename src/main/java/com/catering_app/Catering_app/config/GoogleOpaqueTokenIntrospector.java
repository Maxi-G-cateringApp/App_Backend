...
//
//import com.catering_app.Catering_app.model.UserInfo;
...
//         UserInfo user = userInfoClient.get().uri(uriBuilder->uriBuilder.
//                 path("/oauth2/v3/userinfo").queryParam("access_token",token)
//                 .build())
//                 .retrieve()
